...
def Recognition():
    ...
    for item in data:
        ...
        if item['type'] == 'buttom':
            ...
            rowHeight -= 80
            pic = addhalfpic(pic, rowHeight+80)
...
def paddingdrawithcolor(img,text,org,status):
    ...
    # 增加半透明模板
def addhalfpic(pic,height,width = 800,addP = 80):
    overlay = pic.copy()
    # 创建蒙版
    cv2.rectangle(overlay, (0, height), (800, height+addP), (128, 128, 128), -1)
    # 将蒙版叠加
    alpha = 0.6
