...
def decter(path, outpath):
    ...
    x1, x2, y1, y2 = linecontours(ninfo)  # 提取刻度线、指针
    OZ = [x1, x2, y1, y2]
    angle1 = angle_with_horizontal(OZ)
...
if __name__=="__main__":
    # 输入文件夹
    inputpath='input/bottom_2.jpg'
    # 输出文件夹
    outputpath='output'

    status = decter(inputpath, outputpath)
    print("检测结果：", status)
